...
class Colours {
  ...
  static const primary = Color(0xFF4DE92A);
  static const secondary = Color(0xFF176807);
  static const tertiary = Color.fromARGB(255, 19, 193, 60);

  static const success = Color(0xFF009900);
  static const error = Color(0xFFDA005C);
  static const warning = Color(0xFFF6B229);

  static const gradient = [
    Color.fromARGB(255, 23, 104, 7),
    Color.fromARGB(255, 45, 208, 91),
  ];
