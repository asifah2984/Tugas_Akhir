...
/// Definition of project-level text stlyes / typographies
///
/// DO USE text styles defined in [Typographies] instead
/// of Flutter's literal [TextStyle] or [TextTheme].
///
/// ```dart
/// Text(
///   'Good Bye, Cruel World!',
///   style: Typographies.regular16,
/// )
/// ```
class Typographies {
